...
challenge_C <- function(){
 ...
 #get the average
 aver_time_series_500 = time_series_500/(100/4)
 aver_time_series_1000 = time_series_1000/(100/4)
 aver_time_series_2500 = time_series_2500/(100/4)
 aver_time_series_5000 = time_series_5000/(100/4)

 #plot the graph
 pdf(file = "../Result/challengeC.pdf") 
 plot(NA, xlim = c(0,8*5000), ylim = c(0,100), xlab = "Generation", ylab = "Species Richness",
