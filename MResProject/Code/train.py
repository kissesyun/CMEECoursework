...
#snpsnew = snps[newaxis,:, :, :]
#result2 = model.predict(snpsnew, batch_size=32)
...
#snps = np.load('/home/shiyun/Documents/sandbox/Data/RNF207snps.npy')
#snpsnew = snps[newaxis,:, :, :]
#result = model.predict(snpsnew, batch_size=32)
#print('result:', result)
#b6 result: [[0.06915413]]

#snps = np.load('/home/shiyun/Documents/sandbox/Data/NOS1AP_1.vcfss.npy')
#snpsnew = snps[newaxis,:, :, :]
#result2 = model.predict(snpsnew, batch_size=32)
#print('result2:', result2)
